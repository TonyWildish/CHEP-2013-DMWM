...
PhEDEx has been stable during data taking in LHC Run 1, with development focused on adding support for more flexible workflows, and on providing more tools to the transfer operators.
